    ...
    <form method="POST" action="">
        <div class="row">
            <div class="col-12 col-md-7">
                ...
                <div class="form-detail mb-4 p-3 bg-white">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="district" class="form-control" id="districts" required
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="note" rows="4" placeholder="Nhập ghi chú nếu có"
                        ...
                        <a href="<?php echo '?page=san-pham&id=' . $product['product_id'] ?>"
                            ...
                            <div class="fw-bold">
                                <div class="checkout-price-final">
                                    <?= number_format($product['price_final'], 0, ',', '.') . 'đ' ?></div>
                                <div class="checkout-price-original">
                                    <?= number_format($product['price_original'], 0, ',', '.') . 'đ' ?></div>
                            </div>
                        </a>
                        <?php
              endforeach;
            ...
            ?>
                    ...
                    <button type="submit" name="order-btn"
                        class="btn submit-checkout d-flex align-items-center justify-content-center text-white text-uppercase">
                        Đặt hàng
                    </button>
                </div>
            </div>
